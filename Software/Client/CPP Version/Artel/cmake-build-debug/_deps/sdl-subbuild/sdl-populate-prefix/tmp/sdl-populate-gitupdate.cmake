...
execute_process(
  COMMAND "/usr/bin/git" show-ref "1.2.15"
  WORKING_DIRECTORY "/Users/amirmohammad/Documents/Projects/Artman/Delta Robot/Software/Client/CPP Version/Artel/cmake-build-debug/_deps/sdl-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("1.2.15" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/1.2.15")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/amirmohammad/Documents/Projects/Artman/Delta Robot/Software/Client/CPP Version/Artel/cmake-build-debug/_deps/sdl-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/amirmohammad/Documents/Projects/Artman/Delta Robot/Software/Client/CPP Version/Artel/cmake-build-debug/_deps/sdl-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
