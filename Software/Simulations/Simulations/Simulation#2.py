...
#    ax.set_aspect('equal')
    ...
    c1 = c1[0]
    print(c1)
    lineouts1 = lineCalc(point1posX,point1posY,point1posZ,b - c1,rf)
    c2  = random.sample(Range,  1)
    c2 = c2[0]
    line2Helper = lineCalc(point2posX,point2posY,point2posZ,b - c2,rf)
    lineouts2 = line2Calc(point2posX,point2posY,point2posZ,b - c2,rf,120,line2Helper[0] - point2posX)
    c3  = random.sample(Range,  1)
    c3 = c3[0]
    line3Helper = lineCalc(point3posX,point3posY,point3posZ,b - c3,rf)
    lineouts3 = line2Calc(point3posX,point3posY,point3posZ,b - c3,rf,240,line3Helper[0] - point3posX)
    print(b - c3)
    ########
    ...
    ########
    ToolPosition = forward(b - c1,b - c2, b - c3)
    print(ToolPosition)
